...
| `knowledge-atlas.js` | 0.2.0 (in-repo) | `5c56b75b5ad0eea701776a3a14c28fbd70ba1621cc2f9e06a37d534024d6ec22` | built in-repo: `cd packages/knowledge-atlas && pnpm run build`, then copy `dist/knowledge-atlas.iife.js` here (no CDN — first-party code; refresh the hash on every rebuild) |
